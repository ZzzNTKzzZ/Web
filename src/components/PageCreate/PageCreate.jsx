      ...
      content: [
        {
          ...
          description:
            "Elegant landing page for a fintech startup using Next.js.",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          name: "Anna Nguyen",
          feedback:
            "His design-to-code skills are unmatched. Highly recommended!",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          description:
            "Created scalable design systems for consistent branding.",
